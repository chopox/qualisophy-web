          ...
          <div className="max-w-4xl text-center flex flex-col gap-6">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-4 font-primary">
              <button
                ...
                className="bg-primary hover:bg-primary/90 text-white font-bold py-3 px-8 rounded-lg shadow-lg transition-all transform hover:-translate-y-0.5 text-base border border-transparent cursor-pointer"
              >
                Ver Programas
              </button>
              <a
